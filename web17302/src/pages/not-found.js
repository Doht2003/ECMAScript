const NotFoundPage = () => {
    return /*html*/`
    <div class=" m-5 bg-gray-100 h-screen justify-center">
    ...
    <center class="mt-6">
        <a href="@/index.html" class="text-gray-500 font-mono text-xl bg-gray-200 p-3 rounded-md hover:shadow-md">Go back </a>
    </center>
    </div>
    `;
};
